/*
 ...
 Modify:
 16-10-2016: Modify maskIRQ function (ThanNT).
...
#if defined (RF24_RPi)
    printf_P("================ SPI Configuration ================\n" );
    if (csn_pin < BCM2835_SPI_CS_NONE ){
        printf_P("CSN Pin  \t = %s\n",rf24_csn_e_str_P[csn_pin]);
    }else{
        printf_P("CSN Pin  \t = Custom GPIO%d%s\n", csn_pin,
               csn_pin==RPI_V2_GPIO_P1_26 ? " (CE1) Software Driven" : "" );
    }
    printf_P("CE Pin  \t = Custom GPIO%d\n", ce_pin );
    printf_P("Clock Speed\t = " );
    switch (spi_speed)
    {
    case BCM2835_SPI_SPEED_64MHZ : printf_P("64 Mhz");	break ;
    case BCM2835_SPI_SPEED_32MHZ : printf_P("32 Mhz");	break ;
    case BCM2835_SPI_SPEED_16MHZ : printf_P("16 Mhz");	break ;
    case BCM2835_SPI_SPEED_8MHZ  : printf_P("8 Mhz");	break ;
    case BCM2835_SPI_SPEED_4MHZ  : printf_P("4 Mhz");	break ;
    case BCM2835_SPI_SPEED_2MHZ  : printf_P("2 Mhz");	break ;
    case BCM2835_SPI_SPEED_1MHZ  : printf_P("1 Mhz");	break ;
    case BCM2835_SPI_SPEED_512KHZ: printf_P("512 KHz");	break ;
    case BCM2835_SPI_SPEED_256KHZ: printf_P("256 KHz");	break ;
    case BCM2835_SPI_SPEED_128KHZ: printf_P("128 KHz");	break ;
    case BCM2835_SPI_SPEED_64KHZ : printf_P("64 KHz");	break ;
    case BCM2835_SPI_SPEED_32KHZ : printf_P("32 KHz");	break ;
    case BCM2835_SPI_SPEED_16KHZ : printf_P("16 KHz");	break ;
    case BCM2835_SPI_SPEED_8KHZ  : printf_P("8 KHz");	break ;
    default : printf_P("8 Mhz");	break ;
    }
    printf_P("\n================ NRF Configuration ================\n");
...
void RF24::openReadingPipe(uint8_t child, uint64_t address)
{
    ...
    if (child == 0){
        memcpy_P(pipe0_reading_address,&address,addr_width);
    }
