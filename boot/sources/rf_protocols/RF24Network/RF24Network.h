 ...
 *     memcpy_P(&myDataBuffer,network.frag_ptr->message_buffer,network.frag_ptr->message_size);
 * }		
 * @endcode
 */
 ...
 struct RF24NetworkFrame
{
  ...
  */
  ...
  RF24NetworkFrame(RF24NetworkHeader& _header, const void* _message = NULL, uint16_t _len = 0) :
    ...
    if (_message && _len) {
      memcpy_P(message_buffer,_message,_len);
    }
  }
#else  
...
public:
 ...
 /**@}*/
   ...
   *   memcpy_P(&myBuffer,&f.message_buffer,dataSize);
